...
% regex (make sure to turn off preserve case):
% \\placetable\[none]{}\n\\starttable\[\|l\|]\n\\HL\n\\NC 
% \\startDelimitedTable\n 
...
% (}~)|(}~)
% }~
\placetable[here, split][tab01]{Caption}{
...
{\em Celkový počet individuálních lokalit}~ 8 \input knuth

{\em Archeologický kontext nálezu}~ funerální 2, sídelní 2, náboženský 1, sekundární 6, neznámý 24 \input knuth
...
{\em Objekt}~ stéla 32, architektonický prvek 1, mozaika 1, jiný 1 \input knuth
...
{\em Soukromé nápisy}~ funerální 28, jiný 2 (proklínací destička 2) \input knuth

{\em Veřejné nápisy}~ jiný 1 (z toho hraniční kámen 1) \input knuth

{\em Délka}~ aritm. průměr 6,67 řádku, medián 6, max. délka 22, min. délka 1 \input knuth
