...
{\em Region měst na pobřeží}~ Apollónia Pontská 1, Byzantion 3, Maróneia 3, Mesámbria 3, Topeiros 1 \cite[celkem11]

{\em Region měst ve vnitrozemí}~ Nicopolis ad Istrum 2 \cite[celkem2]\footnote{Celkem tři nápisy nebyly nalezeny v rámci regionu známých měst, editoři korpusů udávají jejich polohu vzhledem k nejbližšímu modernímu sídlišti, či uvádí muzeum, v němž se nachází.}

{\em Celkový počet individuálních lokalit}~ 8

{\em Archeologický kontext nálezu}~ sekundární 3, neznámý 13

{\em Materiál}~ kámen 15 (mramor 13; jiný 2), jiný 1 \cite[z toho dřevo1]
...
{\em Dekorace}~ reliéf 5, bez dekorace 11; reliéfní dekorace figurální 1 nápis \cite[vyskytující se motiv: funerální scéna/symposion1], architektonické prvky 4 nápisy (vyskytující se motiv: kříž 7, christogram 1)
