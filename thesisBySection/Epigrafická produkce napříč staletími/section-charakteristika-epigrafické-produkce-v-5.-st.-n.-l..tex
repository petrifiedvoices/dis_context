...
{\em Region měst na pobřeží}~ Byzantion 3, Maróneia 4, Perinthos (Hérakleia) 1 \cite[celkem8]

{\em Region měst ve vnitrozemí}~ Filippopolis 2, Plótinúpolis 1, Traianúpolis 1 \cite[celkem4]
...
{\em Dekorace}~ reliéf 5, bez dekorace 7; reliéfní dekorace figurální 0, architektonické prvky 5 nápisů (vyskytující se motiv: naiskos 1, sloup 1, jiný 4 \cite[kříž4])
