...
{\em Materiál}~ kámen 3 (mramor 1, místní kámen 1 (póros\postponenotes\footnote{Druh porézního kamene s velkým množstvím zkamenělých ulit mořských živočichů.}), 1 neznámý);

{\em Dochování nosiče}~ 100 \letterpercent{} 1, 75 \letterpercent{} 1, nemožno určit 1

{\em Objekt}~ stéla 3

{\em Dekorace}~ reliéfní dekorace 1 nápis (vyskytující se motiv: stojící osoba 1); architektonická dekorace 1 nápis (vyskytující se motiv: florální motiv 1, anthemion 1)\postponenotes\footnote{Výsledné číslo součtu nápisů nesoucích dekoraci může být vyšší než celkový počet nápisů, protože některé nápisy nesou více druhů dekorace, případně kombinace motivů.}
