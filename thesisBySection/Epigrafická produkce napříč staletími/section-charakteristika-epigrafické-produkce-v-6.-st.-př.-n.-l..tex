...
{\em Dekorace}~ reliéfní dekorace 1 nápis \cite[vyskytující se motiv: stojící osoba1]; architektonická dekorace 1 nápis (vyskytující se motiv: florální motiv 1, anthemion 1)\footnote{Výsledné číslo součtu nápisů nesoucích dekoraci může být vyšší než celkový počet nápisů, protože některé nápisy nesou více druhů dekorace, případně kombinace motivů.}
